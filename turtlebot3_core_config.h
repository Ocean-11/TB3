...
// define servo pin
//#define HVLP_SERVO_PIN                 9 // spray servo pin
#define BAUDRATE                         1000000
#define DXL_ID                           3
#define MAX_POSITION                     4095
// #define HVLP_CLOSE_POS                   (uint32_t)1100 // closed position angle (deg)
// #define HVLP_OPEN_POS                    (uint32_t)2000 // open position angle (deg) - corresponds to 180deg
...
int32_t goal_servo_angle = HVLP_CLOSE_POS; 
int32_t current_servo_angle = HVLP_CLOSE_POS;    
